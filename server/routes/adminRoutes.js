...
const {getAllStaffs, updateStaffStatus, getPatientStats } = require('../controllers/personalizeContorllers/adminControllers')
...
router.get('/admin-dashboard/patient-stats', adminProtect, getPatientStats);
